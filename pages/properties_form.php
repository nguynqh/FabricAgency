        ...
        <div class="page-body-wraper">
            ...
            <div class="main-content-wrap">
                <div class="categories_properties">
                    <div class="main-label item">Them (Xoa,Xem,Sua)</div>
                    ...
                    <div class="product-name item">
                        <h3>Name:</h3>
                        <input type="text" class="input-name" placeholder="Text your category name s">
                    </div>
                    <!-- COLOR -->
                    <div class="product-color item">
                        <h3>Color:</h3>
                        <input type="color" class="input-color" id="colorPicker">
                        <h3 id="colorCode">Your color code: please choose your color</h3>
                    </div>
                    <!-- CURRENT PRICE -->
                    <div class="product-current-price item">
                        <h3 style="font-weight: 500;">Price:</h3>
                        <input type="text" name="" id="" class="" placeholder="Enter category price">
                    </div>
                    <!-- QUANTITY -->
                    <div class="product-quantity item" style="display: block;">
                        ...
                        <div class="action-button-bolt-form">
                            <button id="addBolt">Add a bolt</button>
                            <button id="delBolt">Del</button>
                        </div>
                    </div>
                    <!-- SUBMIT BUTTON -->
